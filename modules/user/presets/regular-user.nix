    ...
    xdg =
      ...
      mkIf nixosConfig.gui.enable {
        configFile = {
          ...
          "Kvantum/Nordic/Nordic.kvconfig".source = "${pkgs.nordic}/share/Kvantum/Nordic/Nordic.kvconfig";
          "Kvantum/Nordic/Nordic.svg".source = "${pkgs.nordic}/share/Kvantum/Nordic/Nordic.svg";
        };
